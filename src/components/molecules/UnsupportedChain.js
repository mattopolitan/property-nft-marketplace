...
export default function UnsupportedChain () {
  ...
  const renderProviderText = () => {
    ...
    const providerTextList = {
      Metamask: 'Add/Change to Ethereum Goerli Testnet on Metamask',
      imToken: 'Add/Change to Ethereum Goerli Testnet on imToken',
      Wallet: 'Add/Change to Ethereum Goerli Testnet on Wallet'
    }
